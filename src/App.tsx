...
function App() {
  return (
    <div className="App flex flex-col items-center justify-center h-screen text-white">
      ...
      <img
        src="https://raw.githubusercontent.com/dupitydumb/NoAffiliate/main/src/assets/icon.png"
        alt="Extension Icon"
      ...
      <div className="p-10 bg-white rounded-lg shadow-2xl max-w-md w-full mb-4 text-black">
        ...
        <img
          src="https://github.com/dupitydumb/NoAffiliate/blob/main/src/assets/tutorial.gif?raw=true"
          alt="Step 1"
          className="mb-4"
        />
      ...
      <a
        href="https://github.com/dupitydumb/NoAffiliate/raw/main/src/assets/AntiAffiliate.zip"
        download
